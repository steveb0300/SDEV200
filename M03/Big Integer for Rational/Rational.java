...
// Create methods to handle rational numbers
...
public class Rational extends Number implements Comparable<Object> {
	...
	// Creat rational with default values
	public Rational() {

		this(new BigInteger("1"), new BigInteger("1"));
	}

	// Create rational with numerator and denominator arguments
	...
	// Override and manual cast double to int
	@Override 
	public int intValue() {
	...
	// Override and manual cast double to float
	@Override 
	...
	// Override and Implement the doubleValue method
	@Override 
	...
	// Override and manual cast double to long
	@Override
	...
	// Override and return positive or negative based off comparison
	@Override
